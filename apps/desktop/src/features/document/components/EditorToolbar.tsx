...
export function EditorToolbar({
  ...
  return (
    <div className="mb-4 flex w-full select-none flex-wrap items-center gap-1 rounded-lg border border-[var(--app-border)] bg-[var(--app-bg)]/82 px-3 py-2 backdrop-blur-sm">
      {shouldShowUndoRedo && (
        <>
          <ToolbarButton
            onClick={handleUndo}
